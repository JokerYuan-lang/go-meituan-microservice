...
const (
	...
	OrderService_ListMerchantOrders_FullMethodName = "/order.OrderService/ListMerchantOrders"
...
type OrderServiceClient interface {
	...
	UpdateOrderStatus(ctx context.Context, in *UpdateOrderStatusRequest, opts ...grpc.CallOption) (*CommonResponse, error)
	// 用户查询自己的订单列表
...
func (c *orderServiceClient) UpdateOrderStatus(ctx context.Context, in *UpdateOrderStatusRequest, opts ...grpc.CallOption) (*CommonResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *orderServiceClient) ListMerchantOrders(ctx context.Context, in *ListMerchantOrdersRequest, opts ...grpc.CallOption) (*ListMerchantOrdersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *orderServiceClient) CancelOrder(ctx context.Context, in *CancelOrderRequest, opts ...grpc.CallOption) (*CommonResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CommonResponse)
...
func (UnimplementedOrderServiceServer) UpdateOrderStatus(context.Context, *UpdateOrderStatusRequest) (*CommonResponse, error) {
...
func (UnimplementedOrderServiceServer) ListMerchantOrders(context.Context, *ListMerchantOrdersRequest) (*ListMerchantOrdersResponse, error) {
...
func (UnimplementedOrderServiceServer) CancelOrder(context.Context, *CancelOrderRequest) (*CommonResponse, error) {
...
func _OrderService_ListMerchantOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ListMerchantOrders(ctx, req.(*ListMerchantOrdersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
